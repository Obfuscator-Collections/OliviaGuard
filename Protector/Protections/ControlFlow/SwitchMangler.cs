...
namespace OliviaGuard.Protector.Protections.ControlFlow
{
    internal class SwitchMangler : ManglerBase
    {
        ...
        public override void Mangle(CilBody body, ScopeBlock root, OliviaLib ctx, MethodDef Method, TypeSig retType)
        {
            this.ctx = ctx;
        ...
        LinkedList<Instruction[]> SplitStatements(InstrBlock block, Trace trace, OliviaLib ctx)
        {
