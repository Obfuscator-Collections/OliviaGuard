    ...
    public sealed class ModuleWriter : ModuleWriterBase
    {
        ...
        void CreateSections()
        {
            ...
            if (TheOptions.AddMvidSection)
                sections.Add(mvidSection = new PESection("!Sugar", 0x42000040));
            sections.Add(textSection = new PESection("!Sugar", 0x60000020));
            sections.Add(sdataSection = new PESection("!Sugar", 0xC0000040));
            if (!(GetWin32Resources() is null))
                sections.Add(rsrcSection = new PESection("!Sugar", 0x40000040));
            // Should be last so any data in a previous section can add relocations
            sections.Add(relocSection = new PESection("!Sugar", 0x42000040));
        }
